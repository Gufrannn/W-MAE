...
def main(args):
    ...
    model = models_mae_16_16_next_precip.__dict__[args.model](norm_pix_loss=args.norm_pix_loss, img_size= args.img_size, patch_size = args.patch_size)
    model_precip = models_mae_16_16_next_precip_outchannel.__dict__[args.model](precip_model=precip_model, norm_pix_loss=args.norm_pix_loss, img_size= args.img_size, patch_size = args.patch_size)
...
if __name__ == '__main__':
    ...
    params['checkpoint_path'] =  os.path.join(save_dir, 'ckpt/checkpoint-125.pth')  # manxin todo aaa
