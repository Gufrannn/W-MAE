...
import models_mae_16_16
from engine_pretrain_16_16 import train_one_epoch
...
def main(args):
    ...
    model = models_mae_16_16.__dict__[args.model](norm_pix_loss=args.norm_pix_loss, img_size= args.img_size, patch_size = args.patch_size)
    model.to(device)
...
if __name__ == '__main__':
    ...
    params['checkpoint_path'] =  os.path.join(save_dir, 'ckpt/checkpoint-578.pth')  # manxin todo aaa
