...
from engine_pretrain_16_16_next_finetune import train_one_epoch
...
def main(args):
    ...
    model = models_mae_16_16_next_finetune.__dict__[args.model](norm_pix_loss=args.norm_pix_loss, img_size= args.img_size, patch_size = args.patch_size)
    model.to(device)
...
if __name__ == '__main__':
    ...
    args.run_num = 'p_qkv_16_16_next_finetune' # 'p_1'
    args.pretrained_ckpt_path = '/home/manxin/codes/fcn/mae/mae-main/output_dir/p_qkv_16_16_next/pretraining/ckpt/checkpoint-cur.pth'
    args.output_dir = '/home/manxin/codes/fcn/mae/mae-main/output_dir'
    args.yaml_config = './config/AFNO_16_16_next_finetune.yaml'
