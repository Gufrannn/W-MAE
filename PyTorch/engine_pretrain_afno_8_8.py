...
def train_one_epoch(model: torch.nn.Module,
    ...
    for data_iter_step, (samples) in enumerate(metric_logger.log_every(data_loader, print_freq, header)):
        ...
        with torch.cuda.amp.autocast():
            ...
            if data_iter_step == 1:
            # if data_iter_step == 2 and epoch == 0:
                for jjj in range(20):
                    save_image(pred[0][jjj], args.save_dir + "/" + str(jjj) + "/" + str(epoch)+ ".png")
                    # save_image(pred[0][jjj], "/home/manxin/codes/FourCastNet/NVLabs-FourCastNet/FourCastNet-master/mae/mae-main/output_dir" + "/" + str(jjj) + "/" + str(epoch)+ ".png")
