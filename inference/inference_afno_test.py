...
if __name__ == '__main__':
    ...
    for iii in range(1000, 9000): #718 725 717 679
        # if iii%5 == 0:
        #     continue
        ff = open(r"/home/lichangyu/data/codes/mae/mae-main/output_dir/afno_8_precip/finetuning/inference/inference_for_valid" + str(fld) + ".txt", "a", encoding="UTF-8")
        ...
        ff.write(str(iii)+'\n')
        flag_mx = 'true'
        args.weights = '/home/lichangyu/data/codes/mae/mae-main/output_dir/afno_8_precip/finetuning/ckpt/checkpoint-' + str(iii) + '.pth'
